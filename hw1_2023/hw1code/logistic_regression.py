...
def getBeta_BatchGradient(train_x, train_y, lr, num_iter, verbose):
    ...
    print("x shape is: " + str(train_x.shape))
    print("y shape is: " + str(train_y.shape))
    #update beta interatively
    for iter in range(0, num_iter):
        #========================#
        # STRART YOUR CODE HERE  #
        #========================#
        pred = sigmoid(train_x @ beta)
        beta = beta + lr*(train_x.transpose() @ (train_y - pred))
        #========================#
        #   END YOUR CODE HERE   #
        #========================# 
...
def getBeta_Newton(train_x, train_y, num_iter, verbose):
    ...
    for iter in range(0, num_iter):
        ...
        #========================#
        pred = sigmoid(train_x @ beta)
        dll = train_x.transpose() @ (train_y - pred)
        ddll = -(train_x.transpose() @ np.diag(pred * (1-pred)) @ train_x)
        beta = beta - (ddll @ dll)
        #========================#
        #   END YOUR CODE HERE   #
        #========================# 
